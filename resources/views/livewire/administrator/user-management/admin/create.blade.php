    ...
    >
        ...
        <div class="flex flex-row items-center gap-2 mb-4">
            ...
            <h5 class="inline-flex items-center text-base font-semibold text-gray-500 dark:text-gray-400"><svg class="w-4 h-4 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                {{ __('platform::common.create_admin') }}</h5>
        ...
        <form wire:submit.prevent="create" class="space-y-6">
            ...
            <div>
                <label class="{{ $errors->has('password') ? 'block mb-2 text-sm font-medium text-red-700 dark:text-red-500' : 'block mb-2 text-sm font-medium text-gray-900 dark:text-white' }}">{{ __('platform::common.password') }}</label>
            ...
            <div class="mt-6 flex items-center justify-center gap-4 w-full">
                ...
                <button type="submit" wire:loading.attr="disabled" wire:target="save" class="flex-1 inline-flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
