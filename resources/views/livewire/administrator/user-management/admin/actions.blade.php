<div class="flex gap-2">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.admin.edit', props: { adminId: {{ $admin->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.admin.roles', props: { adminId: {{ $admin->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.admin.permissions', props: { adminId: {{ $admin->id }} } }">
