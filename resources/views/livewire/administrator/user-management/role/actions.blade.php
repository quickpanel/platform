<div class="flex gap-2">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.role.edit', props: { roleId: {{ $role->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.role.users', props: { id: {{ $role->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.role.permissions', props: { id: {{ $role->id }} } }">
