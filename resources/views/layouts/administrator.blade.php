    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <a href="{{ route('administrator.auth.logout') }}"
                   class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 me-2 dark:focus:ring-yellow-900 flex flex-row items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="lucide lucide-log-out-icon lucide-log-out w-4 h-4 md:w-5 md:h-5">
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-user-management"
                        class="py-2 space-y-2 {{ request()->routeIs('administrator.user-management.*') ? '' : ' hidden'  }}">
                        <li>
                            <a
                ...
                <li>
                    <button
                            type="button"
                            class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            aria-controls="dropdown-log-management"
                            data-collapse-toggle="dropdown-log-management"
                    >
                        ...
                        <span class="flex-1 ms-3 text-start whitespace-nowrap"
                        >{{ __('platform::common.log_management') }}</span
                        >
                        <svg
                                aria-hidden="true"
                                class="w-6 h-6"
