<div class="flex gap-2">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.user.edit', props: { userId: {{ $user->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.user.roles', props: { userId: {{ $user->id }} } }">
    ...
    <button type="button"
            ...
            x-modal:open="{ component: 'platform.administrator.user-management.user.permissions', props: { userId: {{ $user->id }} } }">
